...
public class EntityDeserializerModifier extends BeanDeserializerModifier {
    ...
    Map<Class<? extends BaseObject>, Map<String, BaseDeserializer<Object>>> fieldDeserializers = new HashMap<>();
    ...
    public BeanDeserializerBuilder updateBuilder(DeserializationConfig config, BeanDescription beanDesc, BeanDeserializerBuilder builder) {
        if (!BaseObject.class.isAssignableFrom(beanDesc.getBeanClass())) {
            return builder;
        }

        PropertyService propertyService = AppUtils.getBean(PropertyService.class);
        Class<BaseObject> entityClass = (Class<BaseObject>) beanDesc.getBeanClass();
