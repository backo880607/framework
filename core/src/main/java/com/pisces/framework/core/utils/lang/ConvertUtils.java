...
public class ConvertUtils {
    ...
    public static Object convert(Object value, Class targetClass, boolean ignoreConvertError) {
        ...
        if (targetClass == String.class) {
            ...
            return DateUtils.toLocalDate(DateUtils.parseDate(value));
        } else if (targetClass == LocalTime.class) {
            return DateUtils.toLocalTime(DateUtils.parseDate(value));
            ...
            List<Field> allFields = ClassUtils.getAllFields(targetClass, field -> field.getAnnotation(EnumValue.class) != null);
            if (allFields.size() == 1) {
                Field field = allFields.get(0);

                String fieldGetterName = "get" + StringUtils.firstCharToUpperCase(field.getName());
                List<Method> allMethods = ClassUtils.getAllMethods(targetClass, method -> {
    ...
    public static Date toDate(Object o) {
        ...
        if (o instanceof Temporal) {
            if (o instanceof LocalDateTime) {
                return DateUtils.toDate((LocalDateTime) o);
            }
            if (o instanceof LocalDate) {
                return DateUtils.toDate((LocalDate) o);
            }
            if (o instanceof LocalTime) {
                return DateUtils.toDate((LocalTime) o);
            }
        }
    ...
    public static LocalDateTime toLocalDateTime(Object o) {
        ...
        if (o instanceof Date) {
            return DateUtils.toLocalDateTime((Date) o);
        }
        if (o instanceof LocalDate) {
        ...
        if (o instanceof String) {
            String s = (String) o;
            return DateUtils.parseLocalDateTime(s);
        }
