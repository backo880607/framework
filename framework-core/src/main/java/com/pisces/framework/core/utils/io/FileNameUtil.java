...
public class FileNameUtil {
	...
	public static String extName(String fileName) {
		...
		if (index == -1) {
			...
			// 扩展名中不能包含路径相关的符号
			return StringUtils.containsAny(ext, UNIX_SEPARATOR, WINDOWS_SEPARATOR) ? "" : ext;
		}
	}
	...
	public static String cleanInvalid(String fileName) {
		return StringUtils.isBlank(fileName) ? fileName : StringUtils.delAll(FILE_NAME_INVALID_PATTERN_WIN, fileName);
	}
	...
	public static boolean containsInvalid(String fileName) {
		return (!StringUtils.isBlank(fileName)) && StringUtils.contains(FILE_NAME_INVALID_PATTERN_WIN, fileName);
	}
