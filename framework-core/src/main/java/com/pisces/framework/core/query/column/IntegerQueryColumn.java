 ...
 * @date 2023/06/25
 */
public class IntegerQueryColumn extends QueryColumn {

    public IntegerQueryColumn(String beanName, String fieldName) {
        super(beanName, fieldName);
    }

    public IntegerQueryColumn bind(Class<? extends BeanObject> beanClass) {
        return new IntegerQueryColumn(beanClass.getSimpleName(), getName());
    }
