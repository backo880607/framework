...
import com.pisces.framework.core.exception.ValidateException;
...
public class Validator {
	...
	public static boolean isMatchRegex(Pattern pattern, CharSequence value) {
		return IdCardUtil.isMatch(pattern, value);
	}
	...
	public static boolean isMatchRegex(String regex, CharSequence value) {
		return IdCardUtil.isMatch(regex, value);
	}
	...
	public static boolean hasNumber(CharSequence value) {
		return PatternPool.contains(PatternPool.NUMBERS, value);
	}
	...
	public static boolean hasChinese(CharSequence value) {
		return PatternPool.contains(RegexPool.CHINESES, value);
	}
