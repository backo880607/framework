...
public class StringQueryColumn extends QueryColumn {
    ...
    public StringQueryColumn(String beanName, String fieldName) {
        super(beanName, fieldName);
    }

    public StringQueryColumn bind(Class<? extends BeanObject> beanClass) {
        return new StringQueryColumn(beanClass.getSimpleName(), getName());
    }
    ...
    public QueryCondition start(Object value) {
        if (value == null) {
            return QueryCondition.createEmpty();
        }
        return QueryCondition.create(this, CONDITION_TYPE.START_WITH, value);
    }

    public QueryCondition notStart(Object value) {
        if (value == null) {
            return QueryCondition.createEmpty();
        }
        return QueryCondition.create(this, CONDITION_TYPE.NOT_START_WITH, value);
    }

    public QueryCondition end(Object value) {
        if (value == null) {
            return QueryCondition.createEmpty();
        }
        return QueryCondition.create(this, CONDITION_TYPE.END_WITH, value);
    }

    public QueryCondition notEnd(Object value) {
        if (value == null) {
            return QueryCondition.createEmpty();
        }
        return QueryCondition.create(this, CONDITION_TYPE.NOT_END_WITH, value);
    }
