 ...
 * @date 2022/12/08
 */
public class PrimaryKeyValidator implements ConstraintValidator<PrimaryKey, BeanObject> {

    @Override
    public boolean isValid(BeanObject value, ConstraintValidatorContext context) {
        return true;
