...
public class DynamicRoutingDataSource extends AbstractRoutingDataSource implements InitializingBean, DisposableBean {
    ...
    private DataSource determinePrimaryDataSource() {
        ...
        throw new SystemException("dynamic-datasource can not find primary datasource");
    }
    ...
    public DataSource getDataSource(String ds) {
        ...
        if (strict) {
            throw new SystemException("dynamic-datasource could not find a datasource named" + ds);
        }
        return determinePrimaryDataSource();
    }
    ...
    private void closeDataSource(String ds, DataSource dataSource) {
        try {
            if (dataSource instanceof ItemDataSource) {
                ...
                if (seata) {
                    if (dataSource instanceof DataSourceProxy dataSourceProxy) {
