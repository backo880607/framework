...
import com.pisces.framework.rds.datasource.DynamicDataSourcePropertiesCustomizer;
...
//@ConditionalOnProperty(prefix = RdsProperties.PREFIX, name = "enabled", havingValue = "true", matchIfMissing = true)
